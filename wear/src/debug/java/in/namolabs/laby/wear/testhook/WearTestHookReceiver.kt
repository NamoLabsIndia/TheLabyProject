 ...
 *
 *   adb shell am broadcast -a in.namolabs.laby.wear.TEST_HOOK \
 *     --es cmd <command> --es id <cmd-id> [command extras...]
 *
 * Result is written to cache/testhook/results/<id>.json (readable via run-as in.namolabs.laby.wear)
...
class WearTestHookReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION = "in.namolabs.laby.wear.TEST_HOOK"
