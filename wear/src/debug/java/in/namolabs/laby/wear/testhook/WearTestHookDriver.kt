package in.namolabs.laby.wear.testhook
...
import in.namolabs.laby.wear.mesh.WearMeshService
import in.namolabs.laby.wear.service.WearMeshForegroundService
        ...
        return ok("favorite_status")
            ...
            .put(
                ...
                when (identity.favoriteIndicator) {
                    in.namolabs.laby.wear.ui.FavoriteIndicator.Favorite -> "filled"
                    in.namolabs.laby.wear.ui.FavoriteIndicator.FavoritedUs -> "outlined_orange"
                    in.namolabs.laby.wear.ui.FavoriteIndicator.None -> "outlined"
                }
            )
    }
