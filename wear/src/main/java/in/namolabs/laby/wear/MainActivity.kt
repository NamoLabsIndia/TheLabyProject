...
import in.namolabs.laby.wear.ui.ChatScreen
import in.namolabs.laby.wear.ui.DmScreen
import in.namolabs.laby.wear.ui.NicknameSetupScreen
import in.namolabs.laby.wear.ui.PeopleScreen
import in.namolabs.laby.wear.ui.UserDetailScreen
import in.namolabs.laby.wear.ui.VerificationCodeScreen
import in.namolabs.laby.wear.ui.WearChatState
import in.namolabs.laby.wear.ui.sendPrivateMessage
import in.namolabs.laby.wear.ui.sendPublicMessage
import in.namolabs.laby.wear.ui.theme.BitchatWearTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nicknameChosen = getSharedPreferences("laby_watch_prefs", Context.MODE_PRIVATE)
            ...
            BitchatWearTheme {
                when {
                    ...
                    !nicknameChosen -> NicknameSetupScreen(
                        ...
                        getSharedPreferences("laby_watch_prefs", Context.MODE_PRIVATE)
    ...
    override fun onResume() {
        super.onResume()
        in.namolabs.laby.messaging.LiveVoiceManager.getInstance(applicationContext)
...
internal fun WearNavHost(
    ...
    AnimatedContent(
        ...
        transitionSpec = {
            fadeIn(tween(in.namolabs.laby.wear.ui.theme.BitchatMotion.EMPHASIZED_MS)) togetherWith
                fadeOut(tween(in.namolabs.laby.wear.ui.theme.BitchatMotion.QUICK_MS))
        },
        ...
        when (current) {
            ...
            is WearScreen.TextInput -> {
                ...
                in.namolabs.laby.wear.ui.TextInputScreen(
                    onSend = { text ->
                        mesh?.let { m ->
