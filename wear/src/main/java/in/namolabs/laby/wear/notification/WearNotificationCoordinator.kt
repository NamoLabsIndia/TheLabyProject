package in.namolabs.laby.wear.notification
...
import in.namolabs.laby.wear.MainActivity
...
class WearNotificationCoordinator private constructor(context: Context) {
    ...
    companion object {
        const val EXTRA_OPEN_DM = "in.namolabs.laby.wear.extra.OPEN_DM"
        const val EXTRA_PEER_ID = "in.namolabs.laby.wear.extra.PEER_ID"

        private const val MESSAGE_CHANNEL_ID = "laby_watch_messages"
