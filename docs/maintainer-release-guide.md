...
application ID `in.namolabs.laby`. Wear releases use the independent version
...
```bash
export REPOSITORY=permissionlesstech/laby-android
export TAG=vX.Y.Z
...
- `BUILDINFO.json`
- `SHA256SUMS.unsigned`
- `laby-android-arm64-unsigned.apk`
- `laby-android-armv7-unsigned.apk`
- `laby-android-universal-unsigned.apk`
- `laby-android-x86-unsigned.apk`
- `laby-android-x86_64-unsigned.apk`
- `laby-android-release-unsigned.aab`
- `laby-android-wear-unsigned.apk`
- `laby-android-wear-release-unsigned.aab`
...
- `laby-android-arm64.apk`
- `laby-android-universal.apk`
- `laby-android-wear.apk`
- `laby-android-x86_64.apk`
...
The helper creates `laby-android-play-upload.aab` and
`laby-android-wear-play-upload.aab`, verifies their JAR signatures, proves
...
```text
release-X.Y.Z/laby-android-play-upload.aab
release-X.Y.Z/laby-android-wear-play-upload.aab
```
...
|---|---:|---|
| `laby-android-arm64.apk` | APK release key | Primary direct-install APK |
| `laby-android-universal.apk` | APK release key | Fallback direct-install APK |
| `laby-android-x86_64.apk` | APK release key | x86_64 install APK |
| `laby-android-wear.apk` | APK release key | Wear OS direct-install APK |
| Five phone `laby-android-*-unsigned.apk` files | No | Reproducibility inputs for every phone ABI target |
| `laby-android-release-unsigned.aab` | No | Canonical reproducible Play input |
| `laby-android-play-upload.aab` | Play upload key | Exact bundle uploaded to Play |
| `laby-android-wear-unsigned.apk` | No | Canonical reproducible Wear install input |
| `laby-android-wear-release-unsigned.aab` | No | Canonical reproducible Wear Play input |
| `laby-android-wear-play-upload.aab` | Play upload key | Exact bundle uploaded to the Wear OS track |
...
1. Open Play Console and select `in.namolabs.laby`.
...
9. In **App bundle explorer**, select the uploaded version. If the account
   ...
   matches `laby-android-play-upload.aab` in `BITCHAT_SHA256SUMS`.
...
`laby-android-wear-play-upload.aab`, confirm version code `1000000001`, and
