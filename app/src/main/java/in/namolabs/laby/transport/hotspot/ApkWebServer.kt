...
class ApkWebServer(
    ...
    private fun serveApk(): Response {
        return try {
            ...
            response.addHeader("Content-Disposition", "attachment; filename=\"laby-${appVersion}.apk\"")
...
<body>
    <div class="container">
        ...
        <a href="/laby.apk" class="download-button">
            📥 Download Laby
        </a>
        ...
        <div class="warning">
            ...
            If you already have Laby installed, you may need to uninstall it first before installing this version. Make sure to backup your data if needed.
        </div>
    </div>
</body>
</html>
