package in.namolabs.laby.service
...
import in.namolabs.laby.MainActivity
...
class MeshForegroundService : Service() {
    ...
    companion object {
        private const val CHANNEL_ID = "laby_mesh_service"
        private const val NOTIFICATION_ID = 10001

        const val ACTION_START = "in.namolabs.laby.service.START"
        const val ACTION_STOP = "in.namolabs.laby.service.STOP"
        const val ACTION_QUIT = "in.namolabs.laby.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "in.namolabs.laby.service.UPDATE_NOTIFICATION"
    ...
    private val unifiedMeshService: in.namolabs.laby.mesh.MeshService?
    ...
    override fun onCreate() {
        ...
        updateJob = scope.launch {
            in.namolabs.laby.storage.AppStateStore.peers
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        when (intent?.action) {
            ACTION_STOP -> {
                ...
                updateJob?.cancel()
                updateJob = null
                try { in.namolabs.laby.services.MessageRouter.tryGetInstance()?.stopOutboxScheduler() } catch (_: Exception) { }
    ...
    private fun buildNotification(activePeers: Int): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .addAction(
                ...
                getString(R.string.notification_action_quit_laby),
                quitPendingIntent
            )
            .build()
    }
