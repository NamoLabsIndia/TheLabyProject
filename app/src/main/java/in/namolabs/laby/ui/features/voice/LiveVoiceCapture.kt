package in.namolabs.laby.ui.features.voice
...
internal class LiveVoiceCapture(
    ...
    fun start(): File? {
        ...
        return try {
            ...
            senderThread = Thread(::senderLoop, "laby-ptt-sender").also(Thread::start)
            running.set(true)
            captureThread = Thread(::captureLoop, "laby-ptt-capture").also(Thread::start)
            file
