package in.namolabs.laby.ui.features.file
...
object FileUtils {
     ...
     */
    fun messageTypeForMime(mime: String): in.namolabs.laby.protocol.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> in.namolabs.laby.protocol.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> in.namolabs.laby.protocol.model.BitchatMessageType.Audio
            else -> in.namolabs.laby.protocol.model.BitchatMessageType.File
        }
    }
