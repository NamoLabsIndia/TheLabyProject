...
class CommandProcessor(
    ...
    private fun handleActionCommand(
        ...
        if (parts.size > 1) {
            ...
            val isInLocationChannel = state.selectedLocationChannel.value is in.namolabs.laby.ui.geohash.ChannelID.Location
    ...
    private fun handlePayCommand(
        ...
        if (selectedPeer != null) {
            ...
            val isLocationChannel =
                state.selectedLocationChannel.value is in.namolabs.laby.ui.geohash.ChannelID.Location
    ...
    private fun addSystemMessage(content: String) {
        ...
        when {
            ...
            selectedLocationChannel is in.namolabs.laby.ui.geohash.ChannelID.Location -> {
