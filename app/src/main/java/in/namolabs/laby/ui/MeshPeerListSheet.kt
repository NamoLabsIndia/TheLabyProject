...
import in.namolabs.laby.core.ui.component.sheet.BitchatSheetCenterTopBar
...
fun MeshPeerListSheet(
    ...
    val wifiAwareConnected by in.namolabs.laby.transport.wifiaware.WifiAwareController.connectedPeers.collectAsStateWithLifecycle()
                ...
                LazyColumn(
                    ...
                    when {
                        conversationStoreState is
                            in.namolabs.laby.services.ConversationStoreState.Loading &&
                        ...
                        conversationStoreState is
                            in.namolabs.laby.services.ConversationStoreState.Error &&
                            conversations.isEmpty() -> {
