...
import in.namolabs.laby.ui.features.media.ImageUtils
import in.namolabs.laby.ui.ComposerActionSurface
import in.namolabs.laby.ui.ComposerIconSize
import java.io.File
...
fun ImagePickerButton(
    ...
    val takePictureLauncher = rememberLauncherForActivityResult(
        ...
        if (success && !path.isNullOrBlank()) {
            ...
            val outPath = in.namolabs.laby.ui.features.media.ImageUtils.downscalePathAndSaveToAppFiles(context, path)
    ...
    ComposerActionSurface(
        ...
        Icon(
            ...
            contentDescription = stringResource(in.namolabs.laby.R.string.pick_image),
            tint = tint,
