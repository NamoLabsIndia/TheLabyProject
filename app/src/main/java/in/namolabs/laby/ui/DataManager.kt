...
import in.namolabs.laby.ui.geohash.DEFAULT_LIVE_LOCATION_ENABLED
...
class DataManager(private val context: Context) {
    ...
    private val prefs: SharedPreferences = context.getSharedPreferences("laby_prefs", Context.MODE_PRIVATE)
