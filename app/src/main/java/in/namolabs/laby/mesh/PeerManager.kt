...
class PeerManager {
    ...
    private val stalePeerTimeoutMs: Long = in.namolabs.laby.util.AppConstants.Mesh.STALE_PEER_TIMEOUT_MS
    ...
    private fun startPeriodicCleanup() {
        managerScope.launch {
            while (isActive) {
                delay(in.namolabs.laby.util.AppConstants.Mesh.PEER_CLEANUP_INTERVAL_MS)
                cleanupStalePeers()
            }
        }
    }
