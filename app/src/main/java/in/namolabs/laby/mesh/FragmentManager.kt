...
import in.namolabs.laby.protocol.model.FragmentPayload
...
class FragmentManager {
    ...
    companion object {
        ...
        private const val FRAGMENT_SIZE_THRESHOLD = in.namolabs.laby.util.AppConstants.Fragmentation.FRAGMENT_SIZE_THRESHOLD // Matches iOS: if data.count > 512
        private const val MAX_FRAGMENT_SIZE = in.namolabs.laby.util.AppConstants.Fragmentation.MAX_FRAGMENT_SIZE        // Matches iOS: maxFragmentSize = 469 
        private const val FRAGMENT_TIMEOUT = in.namolabs.laby.util.AppConstants.Fragmentation.FRAGMENT_TIMEOUT_MS     // Matches iOS: 30 seconds cleanup
        private const val CLEANUP_INTERVAL = in.namolabs.laby.util.AppConstants.Fragmentation.CLEANUP_INTERVAL_MS     // 10 seconds cleanup check
    }
    ...
    fun handleFragment(packet: BitchatPacket): BitchatPacket? {
        ...
        try {
            ...
            val maxFragments = in.namolabs.laby.util.AppConstants.Fragmentation.MAX_FRAGMENTS_PER_ID
            ...
            synchronized(fragmentStateLock) {
                ...
                if (isNewSet) {
                    val maxActive = in.namolabs.laby.util.AppConstants.Fragmentation.MAX_ACTIVE_FRAGMENT_SETS
                ...
                val maxTotalBytes = in.namolabs.laby.util.AppConstants.Fragmentation.MAX_FRAGMENT_TOTAL_BYTES
                ...
                val maxGlobalBytes = in.namolabs.laby.util.AppConstants.Fragmentation.MAX_GLOBAL_FRAGMENT_TOTAL_BYTES
