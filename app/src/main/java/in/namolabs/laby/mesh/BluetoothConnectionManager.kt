...
class BluetoothConnectionManager(
    ...
    private fun isGattServerEnabled(): Boolean {
        return isBleTransportEnabled() &&
            (try { in.namolabs.laby.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value } catch (_: Exception) { true })
    }
    ...
    init {
        ...
        try {
            val dbg = in.namolabs.laby.ui.debug.DebugSettingsManager.getInstance()
