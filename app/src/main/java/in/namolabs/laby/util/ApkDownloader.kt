...
internal fun downloadPhaseLabel(phase: ApkDownloader.DownloadPhase): Int = when (phase) {
    ApkDownloader.DownloadPhase.AwaitingConnectivity ->
        in.namolabs.laby.R.string.prepare_apk_phase_awaiting_connectivity
    ApkDownloader.DownloadPhase.Retrying ->
        in.namolabs.laby.R.string.prepare_apk_phase_retrying
    ApkDownloader.DownloadPhase.SelectingSource ->
        in.namolabs.laby.R.string.prepare_apk_phase_selecting_source
    ApkDownloader.DownloadPhase.AwaitingNetworkRoute ->
        in.namolabs.laby.R.string.prepare_apk_phase_awaiting_route
    ApkDownloader.DownloadPhase.Transferring ->
        in.namolabs.laby.R.string.prepare_apk_phase_transferring
    ApkDownloader.DownloadPhase.VerifyingSignature ->
        in.namolabs.laby.R.string.prepare_apk_phase_verifying_signature
}
