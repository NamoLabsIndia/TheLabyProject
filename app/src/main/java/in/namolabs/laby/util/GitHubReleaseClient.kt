...
import in.namolabs.laby.transport.net.OkHttpProvider
...
internal class GitHubReleaseClient(
    ...
    companion object {
        ...
        private const val GITHUB_API_URL =
            "https://api.github.com/repos/permissionlesstech/laby-android/releases/latest"
        ...
        private const val USER_AGENT = "Laby-Android"

        private val SOURCE = ApkDownloadSource(
            id = DefaultApkDownloadSources.GITHUB_ID,
            displayName = "GitHub Releases",
            latestApkUrl = "https://github.com/permissionlesstech/laby-android/releases/latest/" +
                "download/laby-android-universal.apk"
        )
