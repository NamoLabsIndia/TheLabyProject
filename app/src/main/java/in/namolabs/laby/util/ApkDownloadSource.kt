...
/**
 * A trusted location that serves the latest signed universal Laby APK.
 *
    ...
    val all = listOf(
        ApkDownloadSource(
            ...
            latestApkUrls = listOf(
                "https://github.com/permissionlesstech/laby-android/releases/latest/" +
...
enum class ApkDownloadFailureReason(@StringRes val messageRes: Int) {
    ...
    NotBitchat(R.string.prepare_apk_error_not_laby),
