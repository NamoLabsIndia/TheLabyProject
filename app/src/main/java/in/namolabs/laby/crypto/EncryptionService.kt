package in.namolabs.laby.crypto
...
import in.namolabs.laby.crypto.noise.NoiseEncryptionService
 ...
 * 
 * This is the main interface for all encryption/decryption operations in laby.
...
open class EncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val OLD_PREFS_NAME = "laby_crypto"
        private const val SECURE_PREFS_NAME = "laby_crypto_secure"
    }
