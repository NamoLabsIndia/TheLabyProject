...
import in.namolabs.laby.crypto.noise.southernstorm.protocol.*
import java.security.SecureRandom


/**
 * Individual Noise session for a specific peer - REAL IMPLEMENTATION with noise-java
 * 100% compatible with iOS laby Noise Protocol
 */
class NoiseSession(
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = in.namolabs.laby.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour
        private const val REKEY_MESSAGE_LIMIT = in.namolabs.laby.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_SESSION // 10k messages
        ...
        private const val MAX_PAYLOAD_SIZE = in.namolabs.laby.util.AppConstants.Noise.MAX_PAYLOAD_SIZE_BYTES
        ...
        private const val HIGH_NONCE_WARNING_THRESHOLD = in.namolabs.laby.util.AppConstants.Noise.HIGH_NONCE_WARNING_THRESHOLD
