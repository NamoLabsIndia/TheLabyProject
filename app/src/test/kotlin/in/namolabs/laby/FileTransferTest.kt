...
class FileTransferTest {
    ...
    fun `replaceFilePathInContent should correctly format content markers for different file types`() {
        ...
        val imageMessage = BitchatMessage(
            ...
            content = "/data/user/0/in.namolabs.laby/files/images/photo.jpg",
        ...
        val audioMessage = BitchatMessage(
            ...
            content = "/data/user/0/in.namolabs.laby/files/audio/voice.amr",
        ...
        val fileMessage = BitchatMessage(
            ...
            content = "/data/user/0/in.namolabs.laby/files/documents/document.pdf",
        ...
        result = result.replace(
            "/data/user/0/in.namolabs.laby/files/images/photo.jpg",
            "[image] photo.jpg"
        )
    ...
    fun `media picker should handle file size limits correctly`() {
        ...
        val maxAllowedSize = in.namolabs.laby.util.AppConstants.Media.MAX_FILE_SIZE_BYTES
