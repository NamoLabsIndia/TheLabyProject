package in.namolabs.laby.testhook

import android.content.Context
import android.content.Intent
import android.util.Log
import in.namolabs.laby.ui.favorites.FavoritesPersistenceService
import in.namolabs.laby.ui.features.file.FileUtils
import in.namolabs.laby.ui.features.voice.LiveVoiceEvent
...
import in.namolabs.laby.ui.features.voice.LiveVoiceCapture
import in.namolabs.laby.identity.SecureIdentityStateManager
import in.namolabs.laby.mesh.MeshService
import in.namolabs.laby.mesh.PrivateMediaPreparation
import in.namolabs.laby.mesh.TransferProgressManager
...
import in.namolabs.laby.service.MeshForegroundService
...
import in.namolabs.laby.ui.DataManager
import in.namolabs.laby.ui.PrivateMediaRecipientResolver
...
object TestHookDriver {
    ...
    private suspend fun msgRecv(context: Context, intent: Intent): JSONObject {
        ...
        val startTime = System.currentTimeMillis()
        val mesh = mesh(context)
        val matches: (in.namolabs.laby.protocol.model.BitchatMessage) -> Boolean = { msg ->
            msg.timestamp.time >= startTime &&
                msg.senderPeerID != mesh.myPeerID &&
                (contains == null || msg.content.contains(contains)) &&
