 ...
 *
 * Usage:
 *   adb shell am broadcast -a in.namolabs.laby.TEST_HOOK \
 ...
 *   adb shell run-as in.namolabs.laby cat cache/testhook/results/<id>.json
 */
class TestHookReceiver : BroadcastReceiver() {

    companion object {
        const val TAG = "TestHook"
        const val ACTION = "in.namolabs.laby.TEST_HOOK"
