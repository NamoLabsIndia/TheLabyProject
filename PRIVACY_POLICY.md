...
laby is designed with privacy as its foundation. We believe private communication is a fundamental human right. This policy explains how laby protects your privacy.
...
- **Hybrid Functionality** - laby offers two modes of communication:
...
During each session, laby temporarily maintains:
...
### With Other laby Users

When you use laby, nearby peers can see:
...
To provide the core functionality of laby, we access your device's location data. This access is necessary for the following specific purposes:
...
- **How we use it:** We use this permission strictly to discover other laby peers nearby for the "Bluetooth Mesh Chat" mode.
...
laby does not knowingly collect information from children. The app has no age verification because it collects no personal information from anyone.
...
laby is an open source project. For privacy questions:
- Review our code: https://github.com/yourusername/laby
- Open an issue on GitHub
- Join the discussion in public rooms

## Philosophy

Privacy isn't just a feature—it's the entire point. laby proves that modern communication doesn't require surrendering your privacy. No accounts, no servers, no surveillance. Just people talking freely.

---

*This policy is released into the public domain under The Unlicense, just like laby itself.*